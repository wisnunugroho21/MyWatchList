...
public class DependencyDataListFinder<Data extends DependencyData> implements IDataFind<ArrayList<Data>> {
    DataDB<Data> dataDB;
    String idData;
   ...
   /* ArrayList<DataDB> dataDBs;
    ...
    public void CheckData(String idData, OnAsyncTaskCompleteListener onAsyncTaskCompleteListener)
    {
        ...
        SameID_IDListCheck deleteDataInAllList = new SameID_IDListCheck();
        deleteDataInAllList.execute(idData);
    }

    public class SameID_IDListCheck extends AsyncTask<String, Void, Boolean>
    {
        @Override
