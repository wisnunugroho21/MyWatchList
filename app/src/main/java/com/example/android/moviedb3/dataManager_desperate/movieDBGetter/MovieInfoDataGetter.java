...
import com.example.android.moviedb3.dataManager_desperate.dataReplace.SameDependencyDataListReplace;
...
public class MovieInfoDataGetter<Data extends DependencyData> implements IMovieDBGetter
{
    ...
    private class MovieInfoDatabaseGetter extends AsyncTask<Void, Void, ArrayList<Data>>
    {
        ...
        {
            return DataFind.FindData(new DependencyDataListFinder<Data>(dataDB, movieID));
        }
