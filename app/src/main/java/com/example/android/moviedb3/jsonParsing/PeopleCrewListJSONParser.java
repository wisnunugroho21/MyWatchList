...
public class PeopleCrewListJSONParser implements JSONParser<ArrayList<PeopleCrewData>>
{
    @Override
    public ArrayList<PeopleCrewData> Parse(JSONObject jsonObject) {
        ...
        try
        {
            ...
            for(int a = 0; a < crewLength;  a++)
            {
                ...
                String movieName = cast.getString("title");
                if(movieName == null || movieName.equals("null") || movieName.isEmpty())
                {
                    movieName = "";
                }
                ...
                PeopleCrewData crewData = new PeopleCrewData(id, movieName, crewPosition, movieID, peopleID, imageMovie);
